...
import {DutchAcceleratedDecayLib} from "../lib/DutchAcceleratedDecayLib.sol";
...
contract ExclusiveAcceleratedDutchOrderReactor is BaseReactor {
    using Permit2Lib for ResolvedOrder;
    using ExclusiveDutchOrderLib for ExclusiveDutchOrder;
    using DutchAcceleratedDecayLib for DutchOutput[];
    using DutchAcceleratedDecayLib for DutchInput;
